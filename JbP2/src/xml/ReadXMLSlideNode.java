...
public class ReadXMLSlideNode {
  Slide slide;
  List<Slide> slideList = new ArrayList<>();

  // deze bouwt het slide object op
  public List<Slide> readXMLSlideNode(NodeList nodeList) {
	...
	slideList = readXMLNode.readXMLNode(nodeList);
      }

      if (tempNode.hasChildNodes()) {
	// Check if child nodes present.
	readXMLSlideNode(tempNode.getChildNodes());
